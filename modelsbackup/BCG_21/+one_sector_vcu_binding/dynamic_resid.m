...
lhs = y(122);
rhs = 1/(y(118)-params(2)*y(1))-T(1)*y(247)/y(130);
residual(1) = lhs - rhs;
lhs = y(122);
rhs = y(123)+y(124);
residual(2) = lhs - rhs;
residual(3) = y(243)*y(245)*y(246)-y(123)+params(6)*(1-params(8))*y(244);
lhs = y(121);
rhs = (1-params(8))*y(2)+0.0000000000001;
residual(4) = lhs - rhs;
lhs = y(2)*y(126);
rhs = params(10)*y(129)^params(9);
residual(5) = lhs - rhs;
lhs = y(126);
rhs = params(1)*y(116)/(y(2)*y(129));
residual(6) = lhs - rhs;
lhs = y(125);
rhs = y(116)*(1-params(1))/y(127);
residual(7) = lhs - rhs;
lhs = y(114);
rhs = y(116);
residual(8) = lhs - rhs;
...
residual(9) = lhs - rhs;
lhs = y(114);
rhs = params(10)*y(129)^(1+params(9))/(1+params(9))+y(117)+0.0000000000001;
residual(10) = lhs - rhs;
lhs = y(127)-params(12);
rhs = params(4)*(y(3)-params(12))+y(168)+x(it_, 1);
residual(11) = lhs - rhs;
lhs = y(119);
rhs = 0.0000000000001;
residual(12) = lhs - rhs;
