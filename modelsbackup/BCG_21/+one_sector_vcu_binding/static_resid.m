...
lhs = y(9);
rhs = 1/(y(5)-y(5)*params(2))-params(2)*params(6)/(y(5)-y(5)*params(2));
residual(1) = lhs - rhs;
lhs = y(9);
rhs = y(10)+y(11);
residual(2) = lhs - rhs;
...
lhs = y(8);
rhs = (1-params(8))*y(8)+0.0000000000001;
residual(4) = lhs - rhs;
lhs = y(13)*y(8);
...
residual(9) = lhs - rhs;
lhs = y(1);
rhs = params(10)*y(16)^(1+params(9))/(1+params(9))+0.0000000000001+y(4);
residual(10) = lhs - rhs;
lhs = y(14)-params(12);
