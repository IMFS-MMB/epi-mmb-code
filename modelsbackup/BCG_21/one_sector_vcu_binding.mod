%EPI-MMB: To make the mod file run with Dynare 4.6(5.1), we set in = 1e-12 in line 63, the original code set in=0
var y, ypc, v2, c, cpc, in, inpc, k, lambdac, lambdak, lambdai, w2, rk, l2, a, u, pop; 
...
// 14. lambdai
in = 1e-12; % change to go around dynare preprocessing. In original code, in=0 
