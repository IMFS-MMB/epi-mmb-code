% Infection Dynamics needed to calibrate the infection probabilities
% in model with occupation-specific risk. As the transmission probabilities
% are affected due to this change thats why a new calibration is undertaken
